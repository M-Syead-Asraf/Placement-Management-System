...
(1, 'admin1', '123', 'Syead', 'Asraf', 'contact.syead@gmail.com', '9988900001'),
(2, 'mds', '12345', 'Md', 'Saakin', 'mds@gmail.com', '8908600000');
...
(1, 'Sam', 'Infosys', 'Attended', NULL),
(2, 'Sam', 'TCS', 'Unknown', NULL),
(3, 'John', 'Mobinius', 'Unknown', NULL),
(4, 'John', 'Infosys', 'Selected', NULL),
...
(12, 'John', 'Mobinius', 'Unknown', NULL),
(13, 'John', 'Cognizant Technology Solutions', 'Unknown', NULL);
...
(2, 'admin1', 'Hello everybody this is the demo text on your feed youll receive further updates in the same way!!', '2023-05-05', '19:14:39'),
(4, 'mds', 'Infosys company has been added interested students can apply !!\r\n-Admin', '2023-05-05', '20:04:42'),
(7, 'admin1', 'More IT and BPO companies added! -Admin', '2023-05-07', '12:31:27'),
(5, 'admin1', 'Do not post unnecessary comments!!', '2023-05-05', '22:48:06'),
(6, 'admin1', '4 more companies added checkout!!!\r\n-Admin', '2023-05-05', '22:50:41'),
(8, 'admin1', 'Infosys interview is being held tomorrow at 10:00 AM in college campus', '2023-05-08', '11:10:10');
...
(1, 'kumar', '12345', 'Kumar', 'S', 'kumars@gmail.com', '9868789876', 'Which is Favourite Food?', 'Gobi Manchurian', 'BE', '70', '2023', NULL, NULL),
(2, 'John', '12345', 'John', 'W', 'John21@gmail.com', '9742258316', 'Which is your Favourite Mobile Company?', 'Motorola', 'BE', '78', '2023', '92', '72'),
(7, 'sam', '12345', 'Sam', 'S', 'sam489@gmail.com', '9876736565', 'Which is your First Phone?', 'Samsung', 'BCA', '82', '2023', NULL, NULL),
(9, 'vinay', '12345', 'Vinay ', 'Kumar', 'vinay465@gmail.com', '9080216789', 'Which is your First Phone?', 'Nokia', 'BBA', '76', '2023', '81', '73'),
(10, 'bharath', '12345', 'Bharath', 'N', 'bharath4@gmail.com', '9637854993', 'Which is your Favourite Mobile Company?', 'OnePlus', 'BSC', '82', '2023', '59', '82');
COMMIT;
